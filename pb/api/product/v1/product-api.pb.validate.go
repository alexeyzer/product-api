...
// Validate checks the field values on ListFinalProductsResponse_Item with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *ListFinalProductsResponse_Item) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ListFinalProductsResponse_Item with
// the rules defined in the proto definition for this message. If any rules
// are violated, the result is a list of violation errors wrapped in
// ListFinalProductsResponse_ItemMultiError, or nil if none found.
func (m *ListFinalProductsResponse_Item) ValidateAll() error {
	return m.validate(true)
}

func (m *ListFinalProductsResponse_Item) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return ListFinalProductsResponse_ItemMultiError(errors)
	}
	return nil
}

// ListFinalProductsResponse_ItemMultiError is an error wrapping multiple
// validation errors returned by ListFinalProductsResponse_Item.ValidateAll()
// if the designated constraints aren't met.
type ListFinalProductsResponse_ItemMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ListFinalProductsResponse_ItemMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ListFinalProductsResponse_ItemMultiError) AllErrors() []error { return m }

// ListFinalProductsResponse_ItemValidationError is the validation error
// returned by ListFinalProductsResponse_Item.Validate if the designated
// constraints aren't met.
type ListFinalProductsResponse_ItemValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ListFinalProductsResponse_ItemValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ListFinalProductsResponse_ItemValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ListFinalProductsResponse_ItemValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ListFinalProductsResponse_ItemValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ListFinalProductsResponse_ItemValidationError) ErrorName() string {
	return "ListFinalProductsResponse_ItemValidationError"
}

// Error satisfies the builtin error interface
func (e ListFinalProductsResponse_ItemValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sListFinalProductsResponse_Item.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ListFinalProductsResponse_ItemValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ListFinalProductsResponse_ItemValidationError{}
